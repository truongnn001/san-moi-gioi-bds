...
export default function MuaBanPage(){
  const [filters, setFilters] = useState<ProductFilters>({ q: '', type: undefined, provinces: [], wards: [], price: [0, 500_000_000_000], area: [0, 100000] })

  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <h1 className="text-3xl font-bold text-gray-900 mb-6">Mua bán</h1>
