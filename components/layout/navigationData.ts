...
export const navigationTree: NavItem[] = [
  { title: 'Trang chủ', href: '/' },
  {
    ...
    href: '/gioi-thieu',
    children: [
      { title: 'Câu chuyện INLANDV (Xuất phát)', href: '/gioi-thieu?section=xuat-phat' },
      ...
      { title: 'Khách hàng & Đối tác tiêu biểu', href: '/gioi-thieu?section=khach-hang' },
    ],
  },
  {
    title: 'Dịch vụ',
    ...
    children: [
      ...
      { title: 'Thiết kế & Thi công', href: '/dich-vu?section=thiet-ke-thi-cong' },
    ],
  },
  {
    title: 'Bất động sản',
